...
ShippingMethod.prototype = {
    ...
    validate: function () {
        ...
        if (methods.length == 0) {
            OPC.Messenger.add(Translator.translate('Your order cannot be completed at this time as there is no shipping methods available for it. Please make necessary changes in your shipping address.'), 'checkout-shipping-method-load', 'error');
            return false;
        }
...
OPC.Window.prototype = {
    initialize: function (config) {
        this.config = Object.extend({
            ...
            maxHeight: 400,
            triggers: null,
            markup: '<div class="d-shadow-wrap">' + '<div class="content"></div>' + '<div class="d-sh-cn d-sh-tl"></div><div class="d-sh-cn d-sh-tr"></div>' + '</div>' + '<div class="d-sh-cn d-sh-bl"></div><div class="d-sh-cn d-sh-br"></div>' + '<a href="javascript:void(0)" class="close"><i class="icon-remove-sign"></i></a>'
        }, config || {});
        this._prepareMarkup();
    ...
    _prepareMarkup: function () {
        ...
        this.overlay.addClassName('onepagecheckout-window-overlay');
...
function changeSize() {
    ...
    if (width_scr <= 980 && width_scr >= 620) {
        ...
        col1 = document.getElementsByClassName('col-1');
        col1[0].style.width = 30 + "%";
        col2 = document.getElementsByClassName('col-2');
        col2[0].style.width = 31 + "%";
