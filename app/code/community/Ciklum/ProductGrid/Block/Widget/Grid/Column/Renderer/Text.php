...
class Ciklum_ProductGrid_Block_Widget_Grid_Column_Renderer_Text
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Text
{
    ...
    public function getEditableFieldHtml(Varien_Object $row){
        ...
        $html = '<input  style="width:100%" type="text" name="product['.$id. ']['.$index.']" value="'.$value.'" data-original="'.$value.'" data-editable-groupe="'.$index.'" class="editable-field editable-text-field editable-groupe-'.$index.' no-display"/>';
        return $html;
    }
}
