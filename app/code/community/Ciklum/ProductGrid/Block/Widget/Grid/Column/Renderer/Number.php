...
class Ciklum_ProductGrid_Block_Widget_Grid_Column_Renderer_Number
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Number
{
    protected $_defaultWidth = 80;
    ...
    public function getEditableFieldHtml(Varien_Object $row){
        ...
        $html = '<input type="text" name="product['.$id. ']['.$index.']" value="'.$value.'" data-original="'.$value.'" data-editable-groupe="'.$index.'" class="editable-field editable-text-field editable-groupe-'.$index.' no-display"/>';
        return $html;
    }
